...
struct FormulaModel {
    ...
    static let unitFullName: NSDictionary = [
        ...
        "Pressure":["Megapascal", "Newton/square centimeter", "Newton/square millimeter", "Newton/square meter", "Pascal","Torr", "Standard atmosphere", "Bar", "Centimeter mercury (0 °C)", "Centimeter of water (4°C)", "Foot of water (4°C)", "Hectopascal", "Inch mercury (32 °F)", "Inch of water (4°C)", "Kilonewton/square millimeter", "Kilonetwon/square meter", "KiloPascal", "Kilogram-force/square centimeter", "Kilogram-force/square millimeter ", "Kip-force/square inch", "Ksi", "Pound-force/square foot", "Meters of water (4°C)", "megaNewton/square meter", "millibar", "Millimeter mercury (0 °C)", "Millimeters of water (4°C)", "Poundal/square foot", "Psi", "Tons(UK)force/square foot", "Tons(UK)force/square inch", "tons(US)force/square foot", "tons(US)force/square inch"],
